        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredContracts.map((contract, index) => (
            <div key={index} className="border rounded-lg p-4 shadow">
              ...
              <p>
                <span className="font-semibold">Overnight Initial Margin:</span>{" "}
              ...
              <p>
                <span className="font-semibold">Trading Hours (EST):</span>{" "}
              ...
              <p>
                <span className="font-semibold">Newest Month Additions:</span>{" "}
