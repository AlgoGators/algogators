...
_BUILTIN_UNIVERSES: list[Universe] = [
    ...
    Universe(
        ...
        source="world-bank",
        symbols=[
            "USA:NY.GDP.MKTP.KD.ZG",
            "CHN:NY.GDP.MKTP.KD.ZG",
            "JPN:NY.GDP.MKTP.KD.ZG",
            "DEU:NY.GDP.MKTP.KD.ZG",
            "IND:NY.GDP.MKTP.KD.ZG",
            "BRA:NY.GDP.MKTP.KD.ZG",
        ],
...
class UniverseStore:
    ...
    # Inside this class body, bare `list` resolves to the `list()` method above,
    # so the builtin has to be qualified in annotations.
    def resolve(self, name_or_symbols: str) -> builtins.list[str]:
