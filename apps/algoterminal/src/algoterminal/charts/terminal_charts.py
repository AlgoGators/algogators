...
def line_chart(
    series: pd.Series, title: str = "", width: int = 90, height: int = 20, color=ORANGE
) -> str:
    _reset(width, height)
...
def multi_line_chart(
    frame: pd.DataFrame, title: str = "", width: int = 90, height: int = 20
) -> str:
    _reset(width, height)
...
def equity_curve_chart(
    equity: pd.Series, title: str = "Equity Curve", width: int = 90, height: int = 20
) -> str:
    return line_chart(equity, title=title, width=width, height=height, color=ORANGE)


def drawdown_chart(
    equity: pd.Series, title: str = "Drawdown", width: int = 90, height: int = 14
) -> str:
...
def step_chart(
    series: pd.Series, title: str = "", width: int = 90, height: int = 14, color=AMBER
) -> str:
