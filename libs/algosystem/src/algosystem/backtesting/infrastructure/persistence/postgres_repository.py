...
class PostgresBacktestRunRepository:
    ...
    def get_backtest_summary(self, run_id: object) -> dict[str, object] | None:
    ...
    def get_equity_curve(self, run_id: object) -> pd.Series | None:
    ...
    def _insert_result(
        ...
        name: str,
        description: str,
        hyperparameters: Mapping[str, object] | None,
    ) -> None:
    ...
    def _load_equity_series(self, connection: Connection, run_id: str) -> pd.Series | None:
        rows = connection.execute(
