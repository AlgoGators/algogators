...
class AlgoSystem:
    ...
    def __init__(
        ...
        repository: BacktestRunRepository | None = None,
        renderer: TearsheetRenderer | None = None,
    ) -> None:
    ...
    def export_data(
        ...
        result: BacktestResult,
        output_path: object,
        format: str = "csv",  # noqa: A002 - public API keyword, callers pass format=
    ) -> Path:
    ...
    def run_backtest(
        ...
        **kwargs: object,
        ...
        warnings.warn(
            "AlgoSystem.run_backtest() is deprecated; instantiate AlgoSystem and call .backtest().",
            DeprecationWarning,
            stacklevel=2,
        )
...
def _coerce_result(result: object) -> BacktestResult | None:
