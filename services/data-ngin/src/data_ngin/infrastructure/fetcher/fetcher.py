...
class Fetcher(ABC):
    ...
    def detect_time_gaps(
        self, data: list[dict[str, Any]], time_column: str, freq: str
    ) -> list[str]:
        """
        ...
        time_range = pd.date_range(
            start=df[time_column].min(), end=df[time_column].max(), freq=freq
        )
    ...
    def fetch_and_validate(
        self, symbol: str, start_date: str, end_date: str, time_column: str, freq: str
    ) -> list[dict[str, Any]]:
        """
