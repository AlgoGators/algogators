import strawberry
from data_ngin.domain.ports import QueryPort
...
class Query:
    ...
    @strawberry.field
    def latest_date(self, info: strawberry.types.Info) -> str | None:
        repository: QueryPort = info.context["repository"]
        return repository.get_latest_date()

    @strawberry.field
    def earliest_date(self, info: strawberry.types.Info) -> str | None:
        repository: QueryPort = info.context["repository"]
