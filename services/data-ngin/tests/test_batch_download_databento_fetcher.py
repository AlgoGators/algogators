...
import numpy as np
import pandas as pd
from data_ngin.infrastructure.fetcher.batch_download_databento_fetcher import (
...
class TestBatchDownloadDatabentoFetcher(unittest.IsolatedAsyncioTestCase):
    def setUp(self) -> None:
        ...
        self.mock_config = {
            "fetcher": {
                ...
                "module": "batch_download_databento_fetcher",
            },
    ...
    def test_generate_batches(self):
        ...
        print(end_date)
        result = self.fetcher.generate_batches(
            start_date=start_date, end_date=end_date, unit=unit, max_units_allowed=max_units_allowed
        )
    ...
    async def test_generate_and_fetch_data(self):
        ...
        await self.fetcher.generate_and_fetch_data(
            symbol="ES",
    ...
    async def test_generate_and_fetch_data_preserves_chronological_order(self) -> None:
        ...
        self.assertEqual(
            list(result["time"]), ["2023-01-01", "2023-01-02", "2023-01-03", "2023-01-04"]
        )
    ...
    async def test_retrieve_batches_by_default(self) -> None:
        ...
        with (
            patch.object(
                self.fetcher, "generate_and_fetch_data", new_callable=AsyncMock
            ) as mock_batch,
