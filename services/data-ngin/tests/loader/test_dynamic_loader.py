...
from data_ngin.utils.dynamic_loader import (
...
class TestDynamicLoader(unittest.TestCase):
    ...
    @patch("data_ngin.utils.dynamic_loader.importlib.import_module")
    ...
    @patch("data_ngin.utils.dynamic_loader.importlib.import_module")
    @patch("data_ngin.utils.dynamic_loader.getattr")
    def test_load_class_missing_class(
        self, mock_getattr: MagicMock, mock_import_module: MagicMock
    ) -> None:
        """
    ...
    @patch("data_ngin.utils.dynamic_loader.load_class")
    def test_get_instance_valid(self, mock_load_class: MagicMock) -> None:
        ...
        mock_load_class.assert_called_once_with("data_ngin.infrastructure.csv_loader", "CSVLoader")
    ...
    def test_get_instance_expected_port_satisfied(self, mock_load_class: MagicMock) -> None:
        ...
        without error.
        """
        from data_ngin.domain.ports import SymbolSourcePort
    ...
    @patch("data_ngin.utils.dynamic_loader.load_class")
    def test_get_instance_expected_port_violation_raises_type_error(
        self, mock_load_class: MagicMock
    ) -> None:
        """
    ...
    def test_determine_date_range_uses_config_dates_without_repository(self) -> None:
        ...
        with patch("data_ngin.utils.dynamic_loader.OhlcvRepository") as mock_repo_cls:
