...
from research_api.infrastructure.portfolio import strategy_registry as reg
from research_api.services import portfolio_service as svc
...
def test_every_registry_entry_names_a_portfolio(monkeypatch):
    ...
    """
    monkeypatch.setattr(reg, "get_db_connection", lambda: (_ for _ in ()).throw(ValueError()))
